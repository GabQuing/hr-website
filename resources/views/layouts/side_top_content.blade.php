        ...
        <div class="sidenav_parent">
            <div class="sidenav">
                    ...
                    <form method="POST" id="photoForm" enctype="multipart/form-data">
                        ...
                        <div class="user_picture">
                            <label for="user_photo" id="photo_label">
                                ...
                                @else
                                <img src="{{ asset('profile_picture/img/'.auth()->user()->img ) }}" alt=""
                                    id="img_user_photo" loading="lazy">
                                @endif
                            </label>
                ...
                <div class="user_info_logout">
                    ...
                    <p style="font-size: 14px; margin-top: 20px;"><a href="{{ route('logout') }}" id="logout"
                            style="color: #ffffff; text-decoration: none;">Logout</a></p>
                </div>
            </div>
        </div>
    </section>
