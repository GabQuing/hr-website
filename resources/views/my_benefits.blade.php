...
@section('content')
    ...
    <style>
        ...
        table.benefit-history-table td, table.benefit-history-table tr {
    ...
    <div class="u-box u-box-shadow-medium" style="overflow: hidden">
        <form method="POST" action="">
            ...
            <table class="custom_normal_table u-m-10">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <h5 class="u-fw-b u-t-gray">{{ $employee_benefits->health_care ?? 0}}</h5>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <h5 class="u-fw-b u-t-gray">{{ $employee_benefits->vision ?? 0}}</h5>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <h5 class="u-fw-b u-t-gray">{{ $employee_benefits->dental ?? 0}}</h5>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <h5 class="u-fw-b u-t-gray">{{ $employee_benefits->pregnancy ?? 0}}</h5>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <div class="u-m-10">
                <table class="custom_normal_table">
                    <tbody>
                        ...
                        @endif
                        <tr class="">
                            <td><h5 class="u-fw-b">My Benefits - History</h5></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <div class="mob-pending-table u-m-10" style="overflow-x: auto;">
                    ...
                    <thead>
                        <tr class="f-weight-bold u-t-gray">
                          <td rowspan="2"><h5 class="f-weight-bold u-t-center">Created Date</h5></td>
                            ...
                            <td rowspan="2"><h5 class="f-weight-bold u-t-center">Note</h5></td>
                            <td rowspan="2"><h5 class="f-weight-bold u-t-center">Actions</h5></td>
                        </tr>
                        <tr class="f-weight-bold u-t-gray">
                          ...
                          <tr>
                            ...
                            <td class="u-align-items-center">
                              @if ($history->file_path)
                                <a href="{{ route('employee_benefit.download-receipt', $history->id) }}" target="_blank" history-id="{{ $history->id }}" class="u-flex-center-column" type="button">Download Receipt</a>
                              @endif
                            </td>
                          </tr>
                        @endforeach
                ...
                {{ $histories->links() }}
                <p>Showing {{ $histories->firstItem() ?? 0 }} to {{ $histories->lastItem() ?? 0 }} of {{ $histories->total() }} items.</p>
            </div>
