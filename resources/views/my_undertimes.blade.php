@extends('layouts.side_top_content', ['title' => 'My Undertimes'])

@section('module_name', 'My Undertimes')
                ...
                <div style="overflow-x: auto; width: 100%;">
                    <table class="custom_normal_table">
                        <tbody>
                            <tr>
                                <td colspan="4">
                                    <h3 class="f-weight-bold"><i class="fa-solid fa-eye"></i> Undertime Application Form</h3>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <p>No. of Hours:</p>
                                    <input class="u-input-border-boottom" name="reason" type="text" value="0" required readonly>
                                </td>                           
                            </tr>
                            <tr>
                                <td colspan="4">
...
<div class="my_official_business_content" style="display: none">
    <div class="my_official_business_main_content u-bg-white">
        <div class="my_official_business_header">
            <p class="header_title_h2">My Undertimes</p>
        </div>
