    ...
    <div x-data="{ openTab: '{{ $openTab }}' }">
        ...
        <div class="u-box u-box-shadow-medium" style="overflow: hidden">
            <form method="POST" action="{{route('generateTable')}}">
                ...
                <div x-show="openTab === 'pending'" x-transition class="mob-pending-table u-m-10" class="mob-pending-table u-m-10" style="overflow-x: auto;">
                ...
                <div x-show="openTab === 'approved'" x-transition class="mob-pending-table u-m-10" class="mob-approve-table u-m-10" style="overflow-x: auto;">
                    <table class="u-responsive-table">
                        <thead>
                            <tr class="f-weight-bold u-t-gray">
                                <td><h5 class="f-weight-bold">Status</h5></td>
                ...
                <div x-show="openTab === 'rejected_canceled'" x-transition class="mob-pending-table u-m-10" class="mob-rejected-table u-m-10" style="overflow-x: auto;">
                    <table class="u-responsive-table">
                        <thead>
                            <tr class="f-weight-bold u-t-gray">
                                <tr class="f-weight-bold u-t-gray">
